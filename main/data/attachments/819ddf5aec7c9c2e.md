...
Locator: getByTestId('contact-form-reasons')
Expected string: "Choisir"
Received string: "Choose"
Call log:
  - expect.toHaveAttribute with timeout 5000ms
  - waiting for getByTestId('contact-form-reasons')
    3 × locator resolved to <input readonly type="text" inputmode="text" maxlength="524288" placeholder="Choose" aria-invalid="false" aria-required="false" id="contact-form-reasons" _bl_c5ec8319-4177-44c3-b1e3-f3bb90fad76d="" class="mud-input-slot mud-input-root mud-input-root-text mud-input-root-adorned-end mud-select-input"/>
      - unexpected value "Choose"

    at ContactPage.verifyTexts (/home/runner/work/technicaltest-ap/technicaltest-ap/tests/pages/ContactPage.ts:114:39)
    at /home/runner/work/technicaltest-ap/technicaltest-ap/tests/e2e/contact/contact-form.spec.ts:45:27
```
