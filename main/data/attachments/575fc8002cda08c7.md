...
Call log:
  ...
  - waiting for getByTestId('contact-form-phone')
    9 × locator resolved to <input type="tel" maxlength="25" inputmode="numeric" aria-invalid="false" aria-required="false" id="contact-form-phone" placeholder="E.g.: (201) 555-0123" _bl_105383d4-5bc5-474b-82d4-16404e81d6ae="" class="mud-input-slot mud-input-root mud-input-root-text"/>
