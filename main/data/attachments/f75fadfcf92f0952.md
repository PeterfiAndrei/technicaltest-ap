...
Call log:
  ...
  - waiting for getByTestId('contact-form-phone')
    9 × locator resolved to <input type="tel" maxlength="25" inputmode="numeric" aria-invalid="false" aria-required="false" id="contact-form-phone" placeholder="E.g.: (201) 555-0123" _bl_91da7199-adb4-447b-835c-1ad959f6c1de="" class="mud-input-slot mud-input-root mud-input-root-text"/>
