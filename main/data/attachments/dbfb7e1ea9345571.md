...
Call log:
  ...
  - waiting for getByTestId('contact-form-phone')
    8 × locator resolved to <input type="tel" maxlength="25" inputmode="numeric" aria-invalid="false" aria-required="false" id="contact-form-phone" placeholder="E.g.: (201) 555-0123" _bl_7f942945-66c2-446e-b9db-17e702d75a92="" class="mud-input-slot mud-input-root mud-input-root-text"/>
