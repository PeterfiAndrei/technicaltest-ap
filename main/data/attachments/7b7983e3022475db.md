...
Call log:
  ...
  - waiting for getByTestId('contact-form-phone')
    9 × locator resolved to <input type="tel" maxlength="25" inputmode="numeric" aria-invalid="false" aria-required="false" id="contact-form-phone" placeholder="E.g.: (201) 555-0123" _bl_daef022f-2eae-4b6a-98e1-5acb14bf128d="" class="mud-input-slot mud-input-root mud-input-root-text"/>
