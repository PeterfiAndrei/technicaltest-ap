...
Call log:
  ...
  - waiting for getByTestId('contact-form-phone')
    9 × locator resolved to <input type="tel" maxlength="25" inputmode="numeric" aria-invalid="false" aria-required="false" id="contact-form-phone" placeholder="E.g.: (201) 555-0123" _bl_3656caff-d5f3-45ab-bdb4-9b02191de7b3="" class="mud-input-slot mud-input-root mud-input-root-text"/>
